...
class CosineConvolution2D(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel_norm = K.variable(
            np.ones(self.kernel_norm_shape), name='{}_kernel_norm'.format(self.name))
    ...
    def call(self, x, mask=None):
        ...
        Wnorm = K.sqrt(K.sum(K.square(self.W), axis=kernel_sum_axes,
                             keepdims=True) + K.square(b) + K.epsilon())
